...
const keqing_detail = {
  name: "각청",
  summary:
    "번개와 한선검을 사용하는 메인 딜러. 상시 기원을 통해 얻을 수 있다.\n상시 캐릭터 자체가 이미지가 좋지 않는데, 번개 원소 자체의 문제점으로 인해 평가는 특히 좋지 않았다. 현재는 풀 원소가 나오면서 재평가되었지만, 그만큼 오래된 캐릭터라 새로 나온 캐릭터들에겐 다소 밀린다. 그럼에도 귀여운 외모, 특유의 자세(!), 측은지심 등으로 인기가 있었다. 청이만세!\n<em>각청</em>은 리월 칠성중 옥형성(玉衡星)을 맡고 있는 지도자이다. 리월인들은 그녀를 직함인 옥형성이라 부른다. 옥형성은 리월의 토지와 건설·건축을 담당하는 부서이다.\n<em>각청</em>은 리월의 지도자이면서도 최근까지도 신의 통치를 받던 리월을 못마땅해 했다. 인간은 결국 자립해야 한다고 주장했고, 이 주장이 <em>암왕제군</em>이 은퇴를 결심하게 된 계기가 된다. 하지만 실제로 암왕제군이 사망하고, 모든 통치를 칠성이 해야 하는 상황에 이르자, <em>암왕제군</em>의 능력을 인정하지 않을 수 없었다. (현재는 <em>암왕제군</em> 피규어를 모으는 경지에 이르렀다.)\n신에 대한 경외심이 없었기에, <em>암왕제군</em>의 최측근 중 한 명이자 월해정의 비서인 <em>감우</em>와 사이가 좋지 않았다. <em>암왕제군</em>에 명에 따르는 <em>감우</em>는 못마땅해 하면서도 월해정의 비서로서 일을 받아주긴 했을 뿐이었다. <em>암왕제군</em>의 사망후, <em>각청</em>의 태도가 변하면서 관계가 회복되었고, 현재는 자매처럼 보인다는 말을 들을 정도로 친해졌다.\n<em>각청</em>은 예로부터 할아버지의 영향을 많이 받았다. 할아버지는 리월의 토지사업의 대부이자, 전통문화를 연구하는 학자이기도 했다. 부뚜막의 마신인 마르코시우스를 연구하기도 했다.\n<em>각청</em>의 성격은 올곧은 걸로 악명이 높다. 자신의 신분을 유지할 정도의 사치만 부렸다. 특히 효율을 중시했는데, 보름은 걸리는 일을 며칠로 단축시키고자 했다. 덕분에 <em>각청</em>의 업무는 성과도 효율도 뛰어났지만, 보좌관들의 근속은 3개월 이상 가지 못했다. 한번은 직원들에게 근무시간을 1시간 연장하자는 제안을 했다가 강력한 반발에 부딫히며 철회했다. (와중에 30분으로 바꿔 제안하려고 한다.)\n또한 여러 경험을 쌓는 것을 중요하게 여겼는데, 종종 혼자서 검과 비녀만 가지고 황무지를 다니며 수행을 하기도 한다. 한번은 노동환경 개선을 위해, 노동자가 되어 건설현장에서 일을 한 적이 있었다. 그러다 운 나쁘게도 악덕 업주를 만나게 된다. <em>각청</em>은 일을 마무리한 후 직접 그 업주를 고발했다. 운 나쁜건 업주였다.",
  profile: {
    en_name: "刻晴, Keqing",
    gender: "여성",
    rareness: "★★★★★",
