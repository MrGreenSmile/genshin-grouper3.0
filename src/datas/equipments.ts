...
const allArtifacts = [
  ...
  },
  {
    name: "유구한 반암",
    set2: "바위 원��� 피해+15%",
    set4: "바위 원소 반응으로 만들어진 결정 획득 시 파티 내 모든 캐릭터는 해당 원소 피해 보너스를 35% 획득한다. 지속시간 : 10초. 이러한 효���로 1가지 원소 피해 ���너스�� 획득할 수 있다.",
  },
  {
    name: "몰락한 마음",
    set2: "물 원소 피해+15%",
    set4: "원소 전투 스킬 발동 후 15초 동안 일반/강공격으��� 가하는 피해가 30% ��가한다.",
  },
  {
  ...
  },
  {
    name: "견고한 천암",
    set2: "HP+20%",
    set4: "원소 전투 스킬로 적 명중 시 파티 내 주변 모든 캐릭터의 공격력이 20% 증가하고, 보호막 강화 효과가 30% 증가한다. (지속시간 : 3초) 해당 효과는 0.5초마다 최대 1번 발동한다. 해당 성유물을 장착한 캐릭터가 대기상태일 때도 해당 효과가 발��된다.",
  },
  {
    name: "날아오르는 유성",
