...
const hutao_detail = {
  ...
  summary: `
    ...
    <em>호두</em>는 리월의 장례와 제례를 주관하는 '왕생당(往生堂)'의 77대 당주이다. <em>종려</em>가 이곳에서 객경(외부 자문관)으로 근무하고 있으며, 신의 허물 사건 당시, <em>종려</em>를 중심으로 떠나간 신을 기리는 송신의례를 주관했다. 해등절 마다 중심적인 일을 하는 데, 해등절이 축제의 의미도 있지만 제령의 의미도 있기 때문이다.
