...
const hutao_detail = {
  ...
  summary: `
    ...
    <em>호두</em>의 아버지는 왕생당 76대 당주였고, <em>호두</em>와 마찬가지로 어렸을 때부터 의식을 익힐 정도의 천재였다. 하지만 '경계'에 대항하는 의식을 치르던 중 크게 실패하여 희생되었다. 때문에 무망의 언덕이 낮에도 빛이 들지 않는 심령스팟이 되어버렸고, 75대 당주인 할아버지가 뒷수습을 하면서 쇠약해 지게 되었다. <em>호두</em>는 아버지가 이승에 대한 미련이 강해 실패했다고 원망하는 모습을 내비쳤다. (아버지임과 동시에 천재였기에 실망감이 컸던 것 같다.)
