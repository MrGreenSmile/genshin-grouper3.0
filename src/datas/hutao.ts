...
const hutao_detail = {
  ...
  summary: `
    ...
    <em>호두</em>는 사차원스러운 성격으로 유명하다. 칠성 건물 앞 돌사자상 두 개에 이름을 붙여주곤 빗질을 해주는 가 하면, 기묘한 시를 지어 부르기도 한다. 이중 츄츄가는 아이들을 중심으로 유행하기도 했다. 또한 왕생당 행사 기간이라며 할인 쿠폰을 주거나 1+1을 하기도 한다. <em>백출</em>에게는 라이벌 의식을 느끼고 있다. 요리할 땐 확률적으로 '이상한 요리'가 튀어나온다.(!)
