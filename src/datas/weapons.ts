const allWeapon = [
  ...
  },
  {
    ...
    subEffect: {
      title: "비뢰 어궁",
      content:
        "공격력이 20% 증가하고, '비뢰의 문장'의 위세를 획득한다.\n'비뢰의 문장' : 1/2/3스택의 '비뢰의 문장'보유 시, 일반 공격으로 가하는 피해가 각각 12/24/40% - 15/30/50% - 18/36/60% - 21/42/70% - 24/48/80% 증가한다\n'비뢰의 문장' 1 스택 조건 : 일반 공격으로 피해를 가하면 5초간 유지. 원소 전투 스킬을 발동하면 10초간 유지. 캐릭터의 원소 에너지가 100% 미만일 때 유지. 각 '비뢰의 문장'의 지속시간은 따로 적용된다.",
    },
  },
  {
    name: "극지의 별",
