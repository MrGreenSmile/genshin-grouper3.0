...
const klee_detail = {
  name: "클레",
  summary: `법구와 불 원소를 사용하는 메인 딜러. 원신의 마스코트 중 한 명으로, 여름마다 동화같은 모험을 안내해준다.
    작고 귀엽고 어리숙하지만, 엘프족 출신이라 나이는 생각보다 적지 않을 것으로 보인다. 어머니는 '티바트 유람가이드'의 작가, <em>앨리스</em>. <em>앨리스</em>는 티바트에서 유명한 모험가이자 마녀로, 다른 차원을 넘나들 수 있는 것으로 보인다. (<em>바바라</em>에게 이세계의 아이돌에 대해 알려준게 그녀다.) 근데 성격이 워낙 괴짜인데다 파괴적이라 악명이 높다.
    문제는 <em>클레</em>가 그 성격을 닮아 순수한 얼굴로 아무렇지 않게 아무데나 폭탄을 던지고 다니는 폭탄마가 되어 버린 것이다. <em>클레</em>의 취미는 폭탄으로 물고기 잡기. 근데 지나다니는 곳마다 폭탄부터 들이대는 바람에 산불이나 기물파손 등 문제를 일으키고 다닌다. 하르파스튬 축제 때에는 하르파스튬 대신 폭탄을 군중에 던질뻔했다.
    그럴때마다 <em>진</em>이 출동해 혼구멍나고, 반성실에 연행된다. <em>클레</em>는 반성도 하고, 그러면 안된다고 알기도 하지만, 결국 이 일과를 반복한다. 단장 대행 <em>진</em>이 엄마 역할을 하고, 다른 단원들도 어린 조카보듯 잘 어울려주지만, <em>클레</em>는 엄연히 '불꽃 기사'라는 작위도 받은 어엿한 기사단 선배다.
